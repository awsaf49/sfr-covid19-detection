...
class WandbLogger():
    ...
    def __init__(self, opt, name, run_id, data_dict, job_type='Training'):
        ...
        if isinstance(opt.resume, str):  # checks resume from artifact
            ...
            self.wandb_run = wandb.init(config=opt,
                                        resume="allow",
                                        project='siim-covid-detection' if opt.project == 'runs/train' else Path(opt.project).stem,
                                        entity=opt.entity,
                                        name=name,
                                        job_type=job_type,
    ...
    def check_and_upload_dataset(self, opt):
        ...
        config_path = self.log_dataset_artifact(check_file(opt.data),
                                                opt.single_cls,
                                                'siim-covid-detection' if opt.project == 'runs/train' else Path(opt.project).stem)
